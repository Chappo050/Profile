  ...
  return (
    <div>
      ...
      >
        <div
          id="contact"
          className="flex flex-col text-center pt-20 pb-40  justify-center items-center scroll-smooth lg:w-full lg:mt-52 lg:px-20  lg:pt-0 lg:border-2 lg:absolute  lg:left-1/2 lg:transform lg:-translate-x-1/2  lg:z-10 lg:scale-[0.8] lg:bg-slate-400 lg:border-slate-900"
        >
