const Education = ({active} :any) => {
  return (
    <div id="education" className="flex flex-col text-center justify-center items-center pt-32 scroll-smooth md:border-2 md:m-10 md:absolute md:z-10 md:scale-75  md:bg-slate-400 md:border-slate-900  ">
